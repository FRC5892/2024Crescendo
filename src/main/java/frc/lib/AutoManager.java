...
public class AutoManager {
    ...
    static {
        HeroLogger.getDashboard().log(Characterization_MODE_KEY, false);
    ...
    public static void initDashboard() {
        HeroLogger.getDashboard().log("AutoChooser",autoChooser);
       HeroLogger.getDashboard().log("CharacterizationChooser", characterizationChooser);
    }
    /**
    ...
    public static Command getSelected() {
        ...
        boolean characterization = HeroLogger.getDashboard().get(Characterization_MODE_KEY, false);
        if (characterization) {
